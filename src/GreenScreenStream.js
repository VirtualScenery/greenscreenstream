...
const buffer_frag_glsl_1 = __importDefault(require("./glsl/buffer-frag.glsl"));
const buffer_vert_glsl_1 = __importDefault(require("./glsl/buffer-vert.glsl"));
const main_vert_glsl_1 = __importDefault(require("./glsl/main-vert.glsl"));
const main_frag_glsl_1 = __importDefault(require("./glsl/main-frag.glsl"));
class GreenScreenStream {
    constructor(greenScreenMethod, canvas, width, height) {
        ...
        this.mainFrag = main_frag_glsl_1.default;
        this.mainVert = main_vert_glsl_1.default;
        this.bufferVert = buffer_vert_glsl_1.default;
        this.bufferFrag = buffer_frag_glsl_1.default;
