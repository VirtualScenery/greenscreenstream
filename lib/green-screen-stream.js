...
const green_screen_method_enum_1 = require("./models/enums/green-screen-method.enum");
const get_bodypix_mode_util_1 = require("./utils/get-bodypix-mode.util");
const resolution_from_enum_util_1 = require("./utils/resolution-from-enum.util");
class GreenScreenStream {
    constructor(greenScreenMethod, resolution, canvasEl) {
    ...
    setBackground(src) {
        ...
        return new Promise((resolve, reject) => {
            if (bIsImage) {
                ...
                bg.onload = () => __awaiter(this, void 0, void 0, function* () {
                    bg = yield this.scaleImageToCanvas(bg);
                    resolve(bg);
                });
            }
            else {
     ...
     */
    scaleImageToCanvas(image, imageOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!imageOptions)
                imageOptions = {
            ...
            const imageBitmap = yield createImageBitmap(image, imageOptions);
            const canvas = document.createElement('canvas');
    ...
    */
    ...
    setCanvasResolution(resolution) {
        ...
        if (resolution instanceof vector2_1.Vector2 || vector2_1.Vector2.isValidVector2(resolution))
            this.resolution = resolution;
        else
            this.resolution = (0, resolution_from_enum_util_1.resolutionFromEnum)(resolution);
